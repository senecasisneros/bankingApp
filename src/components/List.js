...
export default class List extends Component {
  ...
  startEdit(transaction) {
    this.setState({
      ...
      editAmountInput: transaction.amount
      ...
      let rows = this.props.transactions.map(transaction => {
        if(this.state.editing === transaction._id) {
          return (
            ...
            <td><input type="text" value={this.state.editAmountInput} onChange={e => {this.setState({editAmountInput: e.target.value}) }} /></td>
            ...
            <button type="button" className="btn btn-danger btn-xs" onClick={this.cancelEdit}>Delete
          ...
          return (
            ...
            <td>{transaction.createdAt}</td>
            <td>
            <button type="button" className="btn btn-primary btn-xs" onClick={this.startEdit.bind(null, transaction)}> Edit
            {/* <span className="glyphicon glyphicon-edit"></span> */}
            </button>
            </td>
            <td>
            <button type="button" className="btn btn-danger btn-xs" onClick={this.deleteTrans.bind(null, transaction._id)}> Delete
            {/* <span className="glyphicon glyphicon-remove"></span> */}
            </button>
            </td>
            </tr>
